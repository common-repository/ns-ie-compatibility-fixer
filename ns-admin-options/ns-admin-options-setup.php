...
add_action( 'admin_menu', function()  {
    add_menu_page( 'IE Compatibility fixer', 'IE Compatibility fixer', 'manage_options', plugin_dir_path( __FILE__ ).'ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
